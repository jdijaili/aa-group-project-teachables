...
def seed_projects():
    ...
    cherry_bracelet = Project(
        ...
        project_image="/images/jewelry/cherry-bracelet/diycherryproject1.jpeg",
        category_id=4,
    ...
    tila_bracelet = Project(
        ...
        project_image="/images/jewelry/tila-bracelet/tilabeadproject1.jpeg",
        category_id=4,
    ...
    daisy_bracelet = Project(
        ...
        project_image="/images/jewelry/daisy-bracelet/daisychainproject1.jpeg",
        category_id=4,
    ...
    mother_of_pearl_necklace = Project(
        ...
        project_image="/images/jewelry/mother-of-pearl-necklace/motherofpearlproject1.jpeg",
        category_id=4,
    ...
    shell_necklace = Project(
        ...
        project_image="/images/jewelry/shell-necklace/shellsproject1.jpg",
        category_id=4,
